...
FAKE_META = {
    "CPS3": {"vtk": 5, "npe": 3, "dim": 2, "dofs": 6, "strain_components": 3,
             "n_gauss": 1, "n_faces": 3, "faces": [0, 1, 2], "vtk_permutation": [0, 1, 2]},
    "CPE3": {"vtk": 5, "npe": 3, "dim": 2, "dofs": 6, "strain_components": 3,
             "n_gauss": 1, "n_faces": 3, "faces": [0, 1, 2], "vtk_permutation": [0, 1, 2]},
    "CPS4": {"vtk": 9, "npe": 4, "dim": 2, "dofs": 8, "strain_components": 3,
             "n_gauss": 4, "n_faces": 4, "faces": [0, 1, 2, 3], "vtk_permutation": [0, 1, 2, 3]},
    "CPE4": {"vtk": 9, "npe": 4, "dim": 2, "dofs": 8, "strain_components": 3,
             "n_gauss": 4, "n_faces": 4, "faces": [0, 1, 2, 3], "vtk_permutation": [0, 1, 2, 3]},
    "C3D4": {"vtk": 10, "npe": 4, "dim": 3, "dofs": 12, "strain_components": 6,
             "n_gauss": 1, "n_faces": 4, "faces": [0, 1, 2, 3], "vtk_permutation": [0, 1, 2, 3]},
    "C3D8": {"vtk": 12, "npe": 8, "dim": 3, "dofs": 24, "strain_components": 6,
             "n_gauss": 8, "n_faces": 6, "faces": list(range(8)),
